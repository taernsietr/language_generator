...
const BOOTSTRAP_SQL: [&str; 2] = [
    "CREATE SCHEMA IF NOT EXISTS angelspeech;",
    "CREATE TABLE IF NOT EXISTS angelspeech.generators ( name VARCHAR(128) PRIMARY KEY, categories JSONB NOT NULL, patterns JSONB NOT NULL, ruleset JSONB NOT NULL );",
];
...
pub async fn initialize_pool() -> Data<PgPool> {
    ...
    let database_address = match environment.deref() {
        ...
        _ => String::from("postgresql://angelspeech:scatman@database:5432/angelspeech")
