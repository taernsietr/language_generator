...
Returns the settings for the specified generator. Requires a `generator` to be
passed in as a query param.  
...
`generator`, `min` and `max` syllable lengths and a `text_length` to be passed
as query params.  
